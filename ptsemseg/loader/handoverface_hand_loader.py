...
class handoverfaceHandLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        im_path = pjoin(self.root, "images_resized", im_name + ".jpg")
        lbl_path = pjoin(self.root, "masks", im_name + ".png")
...
if __name__ == '__main__':
    local_path = '/cvlabdata2/home/user/data/hand_over_face'
    ...
    dst = handoverfaceHandLoader(root=local_path, is_transform=True, augmentations=aug)
    bs = 2
