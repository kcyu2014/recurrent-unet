...
class cityscapesLoader(data.Dataset):
    ...
    mean_rgb = {
        ...
        # "cityscapes": [0., 0., 0.],
        "cityscapes": [0.485, 0.456, 0.406],
    }  # pascal mean for PSPNet and ICNet pre-trained model

    std_rgb = {
        "pascal": [0.229, 0.224, 0.225],
        # "cityscapes": [1., 1., 1.],
        "cityscapes": [0.229, 0.224, 0.225],
    }
    ...
    def __init__(
        ...
        self.std = np.array(self.std_rgb[version])
        self.files = {}
...
if __name__ == "__main__":
    ...
    dst = cityscapesLoader(local_path, img_size='same', is_transform=True,
