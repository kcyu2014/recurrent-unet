...
class eythHandLoader(data.Dataset):
    ...
    def __init__(
        ...
        for split in ["train", "val", "trainval", "test"]:
            path = pjoin(self.root, 'train-val-test-split', split + ".txt")
...
if __name__ == '__main__':
    local_path = '/cvlabdata2/home/user/data/eyth_dataset'
    ...
    dst = eythHandLoader(root=local_path, is_transform=True, augmentations=aug)
    bs = 2
