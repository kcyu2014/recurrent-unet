...
class recmid(nn.Module):
    def __init__(self,
        ...
        # convgru
        self.gru = ConvGRU(filters[4], self.hidden_size)

        # transform conv
        self.conv_tfm = nn.Conv2d(self.hidden_size, filters[4], 1)
