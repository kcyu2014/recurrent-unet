{%- set params = [
{ "model": "vanillarn", "dataset": "eythhand", "initial": "1", "scale_weight": 1, "hidden": 32, "gate": 3, "gpu": 0, "level": 4},
{ "model": "rcnn3", "dataset": "eythhand", "initial": "0", "scale_weight": 1, "hidden": 32, "gate": 3, "gpu": 0, "level": 4},
...
#{ "model": "rcnn3", "dataset": "eythhand", "initial": "0", "scale_weight": 0.4, "hidden": 32, "gate": 3, "gpu": 0, "level": 4},
#{ "model": "rcnn3", "dataset": "eythhand", "initial": "1", "scale_weight": 0.4, "hidden": 32, "gate": 3, "gpu": 0, "level": 4},
